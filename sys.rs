...
pub(crate) mod nr {
    ...
    pub const SYS_URETPROBE: usize = 335;
    pub const SYS_UPROBE: usize = 336;
    ...
    pub const SYS_RT_SIGACTION: usize = 512;
    pub const SYS_RT_SIGRETURN: usize = 513;
    pub const SYS_IOCTL: usize = 514;
    pub const SYS_READV: usize = 515;
    pub const SYS_WRITEV: usize = 516;
    pub const SYS_RECVFROM: usize = 517;
    pub const SYS_SENDMSG: usize = 518;
    pub const SYS_RECVMSG: usize = 519;
    pub const SYS_EXECVE: usize = 520;
    pub const SYS_PTRACE: usize = 521;
    pub const SYS_RT_SIGPENDING: usize = 522;
    pub const SYS_RT_SIGTIMEDWAIT: usize = 523;
    pub const SYS_RT_SIGQUEUEINFO: usize = 524;
    pub const SYS_SIGALTSTACK: usize = 525;
    pub const SYS_TIMER_CREATE: usize = 526;
    pub const SYS_MQ_NOTIFY: usize = 527;
    pub const SYS_KEXEC_LOAD: usize = 528;
    pub const SYS_WAITID: usize = 529;
    pub const SYS_SET_ROBUST_LIST: usize = 530;
    pub const SYS_GET_ROBUST_LIST: usize = 531;
    pub const SYS_VMSPLICE: usize = 532;
    pub const SYS_MOVE_PAGES: usize = 533;
    pub const SYS_PREADV: usize = 534;
    pub const SYS_PWRITEV: usize = 535;
    pub const SYS_RT_TGSIGQUEUEINFO: usize = 536;
    pub const SYS_RECVMMSG: usize = 537;
    pub const SYS_SENDMMSG: usize = 538;
    pub const SYS_PROCESS_VM_READV: usize = 539;
    pub const SYS_PROCESS_VM_WRITEV: usize = 540;
    pub const SYS_SETSOCKOPT: usize = 541;
    pub const SYS_GETSOCKOPT: usize = 542;
    pub const SYS_IO_SETUP: usize = 543;
    pub const SYS_IO_SUBMIT: usize = 544;
    pub const SYS_EXECVEAT: usize = 545;
    pub const SYS_PREADV2: usize = 546;
    pub const SYS_PWRITEV2: usize = 547;
}
